...
function main() {
    ...
    var markerControls = new THREEx.ArMarkerControls(arToolkitContext, _camera, {
        type: 'pattern',
        patternUrl: THREEx.ArToolkitContext.baseURL + 'data/vm.patt',
...
*/
    ...
    function onDocumentMouseDown(event) {
        ...
        console.log("raycast pos = ", _raycaster.ray.origin.x.toPrecision(3), ",", _raycaster.ray.origin.y.toPrecision(3), ",", _raycaster.ray.origin.z.toPrecision(3), " dir = ", _raycaster.ray.direction.x.toPrecision(3), ",", _raycaster.ray.direction.y.toPrecision(3), ",", _raycaster.ray.direction.z.toPrecision(3));
